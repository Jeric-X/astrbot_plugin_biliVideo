...
| `auto_push_info_only` | `false` | 自动推送时仅发送视频基本信息，不进行转写和 LLM 总结 |
...
| `auto_push_info_only` | `false` | Push only basic video info on auto push, skipping transcription and LLM summary |
