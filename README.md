...
| `auto_push_summary` | `true` | 自动推送时进行转写和 LLM 总结；关闭后仅发送视频基本信息 |
...
| `auto_push_summary` | `true` | Generate transcription and LLM summary on auto push; disable to send basic info only |
